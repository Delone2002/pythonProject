...
weight=0
inventory = {}
message = 'Для добавления предметов напишите "добавить (название предмета)".\nДля удаления предмета из инвентаря напишите "достать (название предмета)\n"'
message += 'Введите "стоп", чтобы выйти'
